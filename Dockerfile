...
RUN apt-get update && \
  ...
  apt-get update && \
  apt-get upgrade -y && \
  BUILD_PACKAGES="openssh-server supervisor curl nginx php5-fpm git php5-mysql php5-mysql php-apc php5-redis php5-curl php5-gd php5-intl php5-mcrypt php5-memcache php5-sqlite php5-tidy php5-xmlrpc php5-xsl php5-pgsql php5-mongo php-gettext php5-dev libpcre3-dev pwgen" && \
